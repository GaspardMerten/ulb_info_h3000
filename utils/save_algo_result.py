...
def save_algo_result(
    result: AlgoResult,
    config: GlobalConfig,
    path: str = DEFAULT_PATH,
    name_builder=uuid.uuid4,
):
    name = name_builder()
    ...
    rows = [
        ...
        [
            ...
            result.config.number_of_elements_per_generation,
        ],
    ...
    last_generation_sheet.write_row(
        0, 0, ["DNA", "Fitness", "Distance fitness", "Risk fitness"]
    )
