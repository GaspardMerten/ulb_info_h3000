...
from domain.algo.genetics.elements.mutations.mixed_mutations import inversion_or_swap_mutation, \
...
mutations = [inversion_mutation, norse_mutation, scramble_mutation, swap_mutation, inversion_or_swap_mutation,
             inversion_or_swap_or_scramble_mutation]
