...
def main():
    ...
    computing_with_genetics_algo(global_config, SimpleAlgo(config=global_config), GeneticAlgorithmConfig(number_of_generations=1000, number_of_elements_per_generation=20))
